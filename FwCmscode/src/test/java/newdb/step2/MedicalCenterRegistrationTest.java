...
/**
 * Verify the functionality of registering a medical center
 */

public class MedicalCenterRegistrationTest extends BrowserInitiator{
	
	private static final Logger logger = LogManager.getLogger(MedicalCenterRegistrationTest.class.getName());
	...
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(MedicalCenterRegistrationTest.class.getResource("/org/fwcms/tc/mcRegistration/allCountriesMedicalCenterRegistration.json").getFile()));
	...
	public void medicalCenterRegistration(HashMap<String, String> data) throws Exception{
