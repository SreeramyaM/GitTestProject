 ...
 */
public class CreateMedicalCenterThenMakeToActiveStateTest extends BrowserInitiator{
		
	private static final Logger logger = LogManager.getLogger(CreateMedicalCenterThenMakeToActiveStateTest.class.getName());
	...
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(CreateMedicalCenterThenMakeToActiveStateTest.class.getResource("/org/fwcms/tc/mcRegistration/MedicalCenterRegistration.json").getFile()));
	...
	public void createMcRegistrationThenMakeToActive(HashMap<String, String> data) throws Exception{
