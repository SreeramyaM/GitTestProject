...
/**MC_Payment_toBestinet_18 : Confirm the functionality of the "Make Payment" button. 
 * MC_Payment_toBestinet_19 : Bank draft payment mode form details
 * MC_Payment_toBestinet_23 : Confirm the functionality of the "Submit" button on the bank draft details form.
 * MC_Payment_toBestinet_14 : Observe system behavior when clicked on medical center name having pending payment.*/

public class MakePaymentByDraftForMCUnderPendingPaymentTest extends BrowserInitiator {
private static final Logger logger = LogManager.getLogger(MakePaymentByDraftForMCUnderPendingPaymentTest.class.getName());
	...
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(MakePaymentByDraftForMCUnderPendingPaymentTest.class.getResource("/org/fwcms/tc/mcRegistration/MedicalCenterRegistration.json").getFile()));
	...
	public void  makePaymentByDraftForMCUnderPendingPaymentStatus(HashMap<String, String> data) throws Exception{
