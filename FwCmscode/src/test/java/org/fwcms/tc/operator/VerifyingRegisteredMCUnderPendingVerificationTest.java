...
/** MedCentre_Verify_30 :Verify the functionality of the "Verify" button.
 * MedCentre_Verify_29 : Validate the procedure to check the "Verification is complete" checkbox.
 * MedCentre_Verify_15,MedCentre_Verify_37*/

public class VerifyingRegisteredMCUnderPendingVerificationTest extends BrowserInitiator {
private static final Logger logger = LogManager.getLogger(VerifyingRegisteredMCUnderPendingVerificationTest.class.getName());
	...
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(VerifyingRegisteredMCUnderPendingVerificationTest.class.getResource("/org/fwcms/tc/mcRegistration/MedicalCenterRegistration.json").getFile()));
	...
	public void verifyingRegisteredMCUnderPendingVerificationAsOperator(HashMap<String, String> data) throws Exception{
