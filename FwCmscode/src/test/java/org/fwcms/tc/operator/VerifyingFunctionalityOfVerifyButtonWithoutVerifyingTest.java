...
/** MedCentre_Verify_31 : Check the functionality of the "Verify" button in case when all check boxes are not checked.*/

public class VerifyingFunctionalityOfVerifyButtonWithoutVerifyingTest extends BrowserInitiator{
private static final Logger logger = LogManager.getLogger(VerifyingFunctionalityOfVerifyButtonWithoutVerifyingTest.class.getName());
	...
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(VerifyingFunctionalityOfVerifyButtonWithoutVerifyingTest.class.getResource("/org/fwcms/tc/mcRegistration/MedicalCenterRegistration.json").getFile()));
	...
	public void verifyingFunctionalityOfVerifyButtonWithoutVerifying(HashMap<String, String> data) throws Exception{
		...
		verifyMC.clickVerifyMCButton();
		verifyMC.representativeVerificationErrorMessages("* This checkbox is required");
	}
