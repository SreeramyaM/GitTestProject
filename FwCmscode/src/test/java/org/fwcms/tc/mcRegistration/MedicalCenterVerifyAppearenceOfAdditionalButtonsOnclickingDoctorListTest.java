...
/**Verify the appearance of additional buttons when a doctor's name is selected from the list. */

public class MedicalCenterVerifyAppearenceOfAdditionalButtonsOnclickingDoctorListTest extends BrowserInitiator{
	
	@DataProvider(name="getMedicalCenterVerifyAppearenceOfAdditionalButtonsOnclickingDoctorList")
	public Object[][] returnMedicalCenterRegistration() throws Exception{
		JSONArray ja = (JSONArray) new JSONParser().parse(new FileReader(MedicalCenterVerifyAppearenceOfAdditionalButtonsOnclickingDoctorListTest.class.getResource("/org/fwcms/tc/mcRegistration/MedicalCenterRegistration.json").getFile()));
	...
	@Test(dataProvider="getMedicalCenterVerifyAppearenceOfAdditionalButtonsOnclickingDoctorList",description="MedCentre_Reg_33")
	public void medicalCenterVerifyAppearenceOfAdditionalButtonsOnclickingDoctorList(HashMap<String, String> data) throws Exception{
		...
		medicalCenterReg.VerifyAppearenceOfDeleteUpdateCancelButtons();
	}
