...
public class VerifyingRegisteredMCUnderPendingVerificationTest extends BrowserInitiator {
	...
	public void verifyingRegisteredMCUnderPendingVerificationAsPrevilegedUser(HashMap<String, String> data) throws Exception{
		...
		verifyMC.uncheckAllStatusPrivileged();
