...
public class ForgotPasswordPageProp {
	...
	static{
		try {
			if(prop.isEmpty()){
				...
				prop.load(ForgotPasswordPageProp.class.getResourceAsStream("/language/"+lang+"/cdc/ForgotPasswordPage.properties"));
			}
	...
	public static String getpageHeader(){
		return prop.getProperty("pageHeader");
	}
	...
	public static String getregMobileInvaliedChar(){
		return prop.getProperty("regMobileInvaliedChar");
	}
	
	public static String getforgotPasswordSuccess(){
